...
namespace lab26Identity.Controllers
{
    public class CMSController : Controller
    {
        ...
        public CMSController(lab26IdentityContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Dish,Category,Ingredients,Recipe,IsPublished")] CMS cMS)
        {
            if (id != cMS.ID)
            {
                return NotFound();
